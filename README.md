...
| GET  x  | /api/users     | Returns an array users.                                                                                |
...
| PATCH  x | /api/users/:id | Updates the user with the specified `id` using data from the `request body`. Returns the modified user |
